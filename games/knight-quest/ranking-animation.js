/**
 * ========================================
 * RANKING ANIMATION COMPONENT - KNIGHT QUEST
 * ========================================
 *
 ...
 *
 * Adaptado de Master Sequence para Knight Quest.
 * Knight Quest tiene DOS modales: Victory y Game Over.
 */
...
(function() {
    ...
    const GAME_ID = 'knight-quest'; // ID del juego para la API
     ...
     */
    async function showRankingAnimation(playerScore, targetContainer, nameInputId = 'playerNameInput') {
        ...
        const statsDiv = targetContainer.querySelector('.victory-stats, .game-over-stats, #finalStats, #gameOverStats');
        if (statsDiv) {
    ...
    function clearRankingAnimation() {
        ...
        const nameInput1 = document.getElementById('playerNameInput');
        const nameInput2 = document.getElementById('playerNameInputGameOver');
    ...
    console.log('✅ [ranking-animation.js] Knight Quest ranking animation component loaded');
